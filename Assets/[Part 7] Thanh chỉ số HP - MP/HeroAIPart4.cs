...
using UnityEngine;
public class HeroAIPart4 : MonoBehaviour
{
    ...
    private void SkillXXX()
    {
        if(mana >= HpMpUI.instance.Max)
        {
            Debug.Log("Gay Skill...................");
            //To do.............

            mana = 0;
            HpMpUI.instance.SetMp(0);
            return;
        }
        mana += HpMpUI.instance.Max / 10;
        //mana = HpMpUI.instance.Limited(mana);
        HpMpUI.instance.SetMp(mana);
    }
    IEnumerator Skill(){
        skill = false;
